...
@Component({
  selector: 'app-mda-prioritizeupcdelete',
  templateUrl: './mda-prioritizeupcdelete.component.html',
  styleUrls: ['./mda-prioritizeupcdelete.component.css']
})
export class MdaPrioritizeupcdeleteComponent implements OnInit {
